    ...
    public static void main(String[] args) {
        ...
        /*
            if numHours > 40 {
                ...
                message = You worked 42 hours at a rate of $60, but 2 of the hours were overtime, so you got an
        ...
        if (numHours > 40) {
            ...
            netPay = (hourlyRate * 40)  + (overtimeHours * hourlyRate * 1.5);
            message = "You worked "  + numHours + " hours at a rate of $" + hourlyRate + ", but " + overtimeHours +
                    " of the hours were overtime, so you got an additional pay for those hours. Your net pay is $" + netPay;
        } else {
            netPay = (hourlyRate * numHours);
