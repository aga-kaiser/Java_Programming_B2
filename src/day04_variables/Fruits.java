...
public class Fruits {
    ...
    public static void main(String[] args) {
       ...
       // int apples = 50, grapes = 100, bananas = 150;---> You can declare this way as well if all theseNTHREE variables have the SAME DATA TYPE

        System.out.println("This is how many apples we have " + apples );
        // + ---> plus sign here is not ADDITION.
        // It is called CONCATENATION

        System.out.println("Grape: " + grapes);
