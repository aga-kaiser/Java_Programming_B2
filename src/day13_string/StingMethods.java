...
// import java.util.Scanner;// You do not have to import it. Java by default imports this PACKAGE
...
public class StingMethods {
    public static void main(String[] args) {
        ...
        System.out.println(a == b); // Here, we are comparing the memory location and SINCE both were made using the
        // 'new' keyword, both of them in a different location in the HEAP memory
        System.out.println(a.equals(b)); // Here, we are comparing the VALUE itself. No matter what the location is
        // in the memory, I am comparing the values.
