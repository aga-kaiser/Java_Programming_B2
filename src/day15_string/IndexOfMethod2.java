...
public class IndexOfMethod2 {
    public static void main(String[] args) {
        ...
        System.out.println("First i index: " + str.indexOf('i')); // you can do it with character as well
        System.out.println("Last i index" + str.lastIndexOf("i"));
        System.out.println("Last i index" + str.lastIndexOf('i')); // you can do it with character as well
