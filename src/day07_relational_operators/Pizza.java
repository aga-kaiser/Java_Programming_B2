...
public class Pizza {
    ...
    public static void main(String[] args) {
        ...
        String report =" We ordered " + typeOfPizza + " pizza with " + numOfSlices + " slices, " + numOfPeople +
                "people ate " + slicesPerPerson + " slices each. There were " + slicesLeftOver + " slices left";
